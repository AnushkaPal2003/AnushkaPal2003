...
**Data Scientist** · Python · SQL · Machine Learning · Power BI · MLOps  
...
B.Sc. Mathematics graduate (University of Delhi) currently completing a Data Science & AI program at Learnbay. I build end-to-end ML pipelines — from raw data to deployed models — with a focus on solving real business problems, not just fitting models.

- 🔭 Currently working on: outreach intelligence systems and NLP projects  
...
| 🦠 [Covid Forecasting – Prophet](https://github.com/AnushkaPal2003/Facebook-Prophet-Model-Covid-Dataset) | Time series forecasting of Covid trends using Facebook Prophet | Python · Prophet · Pandas · Matplotlib |
| 🎬 [Movie Recommendation System](https://github.com/AnushkaPal2003/Movie-Recommendation-system) | Content-based filtering using TF-IDF and cosine similarity | Python · Scikit-learn · NLP |
| 🧠 [Sentiment Analysis](https://github.com/AnushkaPal2003/sentiment-analysis) | Text classification pipeline with preprocessing and model comparison | Python · NLP · Scikit-learn |
| 👥 [Customer Segmentation](https://github.com/AnushkaPal2003/Customer-Segmentation) | Clustering-based customer segments for targeted marketing | K-Means · Python · Seaborn |
| 🐱 [Cat vs Dog – Deep Learning](https://github.com/AnushkaPal2003/Cat_vs_Dog_Prediction-Deep-Learning-) | CNN image classifier built from scratch | TensorFlow · Keras · CNN |
...
| 🏠 [Boston House Price Prediction](https://github.com/AnushkaPal2003/Boston-House-Price-Prediction) | Regression model with EDA and feature importance analysis | Python · Scikit-learn · Matplotlib |
...
**MLOps** &nbsp; ![MLflow](https://img.shields.io/badge/MLflow-0194E2?style=flat&logo=mlflow&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white) ![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat&logo=streamlit&logoColor=white)
